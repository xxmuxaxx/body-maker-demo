...
import { beardKeyFor, hairStyleFor, hasGeneratedHead, headKeyFor } from "./characterLayers";
...
const HeadAvatar = ({ appearance, sex = "man", className }) => {
    const id = useId();
    ...
    return (
        <svg className={className || undefined} width="57" height="91" viewBox="66 -10 65 104" xmlns="http://www.w3.org/2000/svg">
            <GeneratedHead id={id} headKey={headKey} beardKey={beardKeyFor(sex, appearance)} appearance={appearance}/>
        </svg>
    );
};
